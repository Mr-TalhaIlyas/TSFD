...
def binarize(x):
    ...
    # i am adding following lines b/c after morphological operations the op labels were not
    # consecutive e.g they were like [0, 1, 3, 5, 6], So, following 4 lines will change that to
    # [0, 1, 2, 3, 4]
    unq = np.unique(out)
    new = out
